...
class HRPC {
  constructor(stream) {
    ...
    this._requestEncodings = new Map([
      ['@api/hello-world', getEncoding('@api/hello-world-request')],
    ])
    this._responseEncodings = new Map([
      ['@api/hello-world', getEncoding('@api/hello-world-response')],
    ])
  ...
  async helloWorld(args) {
    return this._call('@api/hello-world', args)
  }

  onHelloWorld(responseFn) {
    this._handlers['@api/hello-world'] = responseFn
  }
